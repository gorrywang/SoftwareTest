...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="${pageContext.request.contextPath }/webNotice">通知</a>
						</li>
						<li><a href="${pageContext.request.contextPath }/webConfirm">信息确认</a></li>
						<li><a href="${pageContext.request.contextPath }/webSmh">说明会回执</a>
						</li>
						<li class="active"><a>大赛回执</a></li>
					</ul>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<br />
			<form method="post"
				action="${pageContext.request.contextPath }/postDs">
				...
				<div class="form-group">
					<label for="exampleInputName1">联系老师职务</label> <input name="zw"
						type="text" class="form-control" placeholder="请输入联系老师职务">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="exampleInputName1">通讯地址</label> <input name="addrs"
						type="text" class="form-control" placeholder="请输入通讯地址">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="exampleInputName1">抵达车次</label> <input name="car"
						type="text" class="form-control" placeholder="请输入抵达车次">
				</div>
				<div class="form-group">
					<label for="name">是否需要接站</label> <select class="form-control"
						name="jz">
