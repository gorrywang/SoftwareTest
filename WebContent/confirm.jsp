			...
			<form method="post"
				...
				<div class="form-group">
					<label for="exampleInputName1">领队</label> <input
						value="${data.lead }" name="lead" type="text" class="form-control"
						placeholder="请输入领队名称">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="exampleInputName1">指导老师一联系方式</label> <input
						value="${data.tel1 }" name="tel1" type="text" class="form-control"
						placeholder="请输入指导老师一联系方式">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="exampleInputName1">指导老师二联系方式</label> <input
						value="${data.tel2 }" name="tel2" type="text" class="form-control"
						placeholder="请输入指导老师二联系方式">
				</div>
				<div class="form-group">
					<label for="exampleInputName1">学生一</label> <input
						value="${data.stu1 }" name="stu1" type="text" class="form-control"
						placeholder="请输入学生一名称">
				</div>
				<div class="form-group">
					<label for="exampleInputName1">学生二</label> <input
						value="${data.stu2 }" name="stu2" type="text" class="form-control"
						placeholder="请输入学生二名称">
				</div>
				<div class="form-group">
					<label for="exampleInputName1">学生三</label> <input
						value="${data.stu3 }" name="stu3" type="text" class="form-control"
						placeholder="请输入学生三名称">
				</div>
				<c:choose>
					...
					<c:otherwise>
						<button type="submit" class="btn btn-default">信息无误</button>
					</c:otherwise>
				</c:choose>
				<h6>
